...
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/frontend/jquery.share.css')); ?>"/>
<?php $__env->stopSection(); ?>
...
<section class="bannerWrapper">
    ...
    <div class="col-sm-10">
    <div class="adsBanner">
      <div class="adsBannerTop"><img src="<?php echo e(asset('assets/images/eventday/ads1.jpg')); ?>" class="img-responsive"></div>
      <div class="adsBannerBtm">
      <div class="row">
        <div class="col-xs-4 col-sm-4"><img src="<?php echo e(asset('assets/images/eventday/ads2.jpg')); ?>" class="img-responsive"></div>
        <div class="col-xs-4 col-sm-4"><img src="<?php echo e(asset('assets/images/eventday/ads3.jpg')); ?>" class="img-responsive"></div>
        <div class="col-xs-4 col-sm-4"><img src="<?php echo e(asset('assets/images/eventday/ads4.jpg')); ?>" class="img-responsive"></div>
      </div>
      </div>
    </div>
      <div class="navHighlight">
        <ul>
          <?php foreach($ads_category as $cat): ?>
              <li><a href="<?php echo url('list-ads',$cat->slug); ?>"><?php echo $cat->name; ?></a></li>
            <?php endforeach; ?>
          <li><a href="<?php echo e(route('ads-category')); ?>">More <i class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>
        </ul>
      </div>
      </div>
      <div class="col-sm-1"></div>
...
<div class="contantWrapper">
    <div class="container">
      ...
      <div class="filterSearch">
        ...
        <?php echo Form::open(['url' => 'filtereventbyprice']); ?>

        <select id="price" name="price" class="form-control" onchange="this.form.submit()">
                    <option>Price</option>
                    <option value="10">Below <?php echo Helper::getPricesymbol(); ?> 10</option>
                    <option value="50">Below <?php echo Helper::getPricesymbol(); ?> 50</option>
                    <option value="100">Below <?php echo Helper::getPricesymbol(); ?> 100</option>
                    <option value="200">Below <?php echo Helper::getPricesymbol(); ?> 200</option>
      ...
      <div class="col-md-4 col-sm-4 col-xs-12">
        <div class="panel panel-default">
            <div class="panel-image">
              <div class="eventPrice">Price: <?php echo Helper::getPrice($event->ticket_price); ?></div>
              <div class="eventLogoWrap"><div class="eventlogo"><img class="img-responsive img-circle" src="<?php echo e(url('user_circularthumb',$event->organizer()->first()->pic)); ?>"/></div></div>
              <a href="<?php echo e(URL::to('event/'.$event->slug)); ?>">
                <?php if($event->photo): ?>
                <img class="img-responsive img-hover" src="thumbnail2/<?php echo $event->photo; ?>" alt="">
                <?php else: ?>
             ...
             <div class="panel-body">
              ...
              <?php echo date('D, M d, g a ',strtotime($event->date)); ?></div>
              <h3><?php echo $event->name; ?></h3>
              <!-- <div class="date">Date 25th June2016</div> -->
              <div class="address"><i class="fa fa-map-marker" aria-hidden="true"></i> <?php echo $event->location; ?></div>
                  <p><!-- <?php echo str_limit($event->description,150, '...'); ?> --></p>
              <div class="property-meta">
              <ul>
                <li><a href="<?php echo e(URL::to('event/'.$event->slug)); ?>"><i class="fa fa-info-circle" aria-hidden="true"></i> More Info</a></li>
                <li class="centerShare">

                <p class="text-center">
        <button type="button"  class=" btn-share btn btn-simple popover-html" data-text="<?php echo e($event->name); ?>" data-link="<?php echo e(URL::to('event/'.$event->slug)); ?>" data-container="body" data-toggle="popover" data-placement="top">
        ...
        <span id="popoverExampleHiddenContent" class="hidden">
          ...
          <a target="_blank" href="#" class="btn-media envelope">
            <i class="fa fa-envelope"></i>
                ...
                <li class="pull-right"> <a href="<?php echo e(url('events/book',$event->id)); ?>"><i class="fa fa-ticket" aria-hidden="true"></i> Book Tickets</a></li>
              </ul>
              </div>
            </div>
        </div>
    ...
    <?php endforeach; ?>
      ...
      <div class="newSetion">
        <div class="row">
          ...
          <p><a href="<?php echo e(URL::to('newsitem/'.$newsitem->slug)); ?>"><strong> <?php echo e($newsitem->title); ?> </strong>
          <span> <?php echo e($newsitem->created_at->diffForHumans()); ?></span>
          
          <?php echo str_limit($newsitem->content,150, '...'); ?>
          ...
          <div class="col-sm-4">
            ...
            <?php if(count($popularevents)): ?>
              <?php foreach($popularevents as $event): ?>
                <p style="min-height: 100px;">
                <?php if($event->photo): ?>
                <img class="img-responsive img-hover" src="thumbnail3/<?php echo $event->photo; ?>" alt="">
                <?php else: ?>
                 <img src="<?php echo e(asset('assets/images/eventday/news1.jpg')); ?>" alt="">
                <?php endif; ?>

                <a href="<?php echo e(URL::to('event/'.$event->slug)); ?>"><strong> <?php echo $event->name; ?> </strong>
               <?php echo str_limit($event->description,100, '...'); ?>
...
<section class="contantWrapper testimonial">
  <div class="container">
    ...
    <div class="row"> 
      ...
      <div class="col-sm-8">
        <p><?php echo e($testimonial->description); ?><span><strong><?php echo e($testimonial->name); ?></strong><br>
         <?php echo e($testimonial->title); ?><br>
          <?php echo e($testimonial->company); ?></span></p>
      </div>
...
<!-- page level js starts-->
    ...
    <script type="text/javascript" src="<?php echo e(asset('assets/js/frontend/jquery.share.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/eventday/moment.js')); ?>"></script>
    <script>
...
<?php $__env->startSection('header_styles_comingsoon'); ?>
...
<?php /* slider */ ?>
<?php $__env->startSection('top_comingsoon'); ?>
    <!--Carousel Start -->
...
<?php /* content */ ?>
<?php $__env->startSection('content_comingsoon'); ?>
    <div class="container">
...
<?php /* footer scripts */ ?>
<?php $__env->startSection('footer_scripts_comingsoon'); ?>
    <!-- page level js starts-->
...
<?php echo $__env->make('layouts/eventday', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>