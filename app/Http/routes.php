...
Route::get('currency/{currency}', function ($currency) {
    ...
    Route::group(array('middleware' => 'SentinelUser'), function () {
        ...
        Route::post('close_ticket/{ticket_id}', array('as' => 'close_ticket', 'uses' => 'TicketsController@close'));

         

        Route::get('tickets-all', array('as' => 'tickets-all', 'uses' => 'TicketsController@index'));
