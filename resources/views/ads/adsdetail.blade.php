            ...
            <div class="container globalWrap">
                    ...
                    <div class="col-sm-8">
                        <div class="row">
                                ...
                                <ul class="event-list">
                                    <li>
                                        <div class="info">
                                            ...
                                            <div class="desc"><i class="fa fa-map-marker"
                                                                 aria-hidden="true"></i> {!! $ad->location !!}
                                                <div class="rating">
                                                ...
                                                <div class="topReview"> Reviews (<strong
                                                            class="colorRed">{!! count($ad->reviews()->get()) !!}</strong>)
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                            ...
                            <div class="col-sm-2 mt1px">
                                <a type="button" data-toggle="modal" data-target="#bookModal"
                                   class="btn btn-secondary searchBtn">Book Now</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4 mt1px">
                        <button class="btn btn-primary pullright" data-toggle="modal" data-target="#myModal">Send
                            Message
                        </button>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <div class="customerEventL">
                            <div class="eventImg">
                                @if($ad->photo)
                                    <img src="{{ URL::to('/uploads/crudfiles/'.$ad->photo)  }}" class="img-responsive"
                                         alt="Image">
                                @endif
                            </div>
                            <div class=" navPhotoVideo">
                                @if(count($ad->photos()->get())) <a href="javascript:void(0);"
                                                                    id="showphoto">Photo</a>@endif
                                @if($ad->video)<a href="javascript:void(0);" id="showvideo">Video Promo</a>@endif
                            </div>
                            <p>{!! $ad->description !!}</p>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="customerSocial">
                                            <a href="{{ $share['facebook'] }}"><i class="fa fa-facebook-square"
                                                                                  aria-hidden="true"></i></a>
                                            <a href="{{ $share['twitter'] }}"><i class="fa fa-twitter-square"
                                                                                 aria-hidden="true"></i></a>
                                            <a href="{{ $share['pinterest'] }}"><i class="fa fa-pinterest-square"
                                                                                   aria-hidden="true"></i></a>
                                            <a href="{{ $share['email'] }}"><i class="fa fa-envelope-square"
                                                                               aria-hidden="true"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="favBox pull-right">
                                            <a href="{{ route('view_counter.like', array('class_name' => 'Ad', 'object_id' => $ad->id)) }}"
                                               class="btn btn-secondary"><i class="fa fa-heart-o"
                                                                            aria-hidden="true"></i>
                                                ({{ $ad->likes_count() }}) Likes</a>
                        ...
                        {!! $review->updated_at->diffForHumans() !!}
                                ...
                                @if($reviewable)
                                    ...
                                    <div class="form-group ratingAds">
                                        <div data="{!! $ad->id !!}" id="stars" class="stars starrr rating"
                ...
                <div class="leftContent">
                    <div class="leftList otherEvent">
                        <h3>Other {!! isset($ads_category[$ad->ads_category_id]) ? $ads_category[$ad->ads_category_id]: 'null'!!}</h3>
                        @if(count($otherads))
                            @foreach($otherads as $other)
                                <p><a href="{{ URL::to('ads/details',$other->slug)}}"><span
                                                class="otherEventTitle">{{ $other->title}}</span>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer ">
                    ...
                    <button id="booknow" type="button" class="btn btn-warning btn-lg" style="width: 100%;"><span
                                class="glyphicon glyphicon-ok-sign"></span>Book Now
                    </button>
                </div>
            </div>
            <!-- /.modal-content -->
