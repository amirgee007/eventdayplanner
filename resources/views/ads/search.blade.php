        ...
        <div class="contantWrapper innercontantWrapper adsPage">
            <div class="container globalWrap">
                <div class="row">
                    <div class="col-sm-3">
                        <div class="leftContent">
                                ...
                                <div class="row">
                                    <div class="col-sm-5">
                                        <div class="input-group">
                                            <input name="fromdate" type="text" id='datepicker1' placeholder="Date"
                                                   class="form-control" placeholder="Date" onchange="filterbydate()"
                                    ...
                                    <div class="col-sm-5">
                                        <div class="input-group">
                                            <input name="todate" type="text" id='datepicker2' placeholder="Date"
                                                   class="form-control" placeholder="Date" onchange="filterbydate()"
                                                   aria-describedby="basic-addon1">
                                        </div>
                                    </div>
                            ...
                            <div class="leftList">
                                ...
                                <ul>
                                    <li><a href="{{Request::url()}}?rating=5">
                                            <div class="rating"><i class="fa fa-star" aria-hidden="true"></i><i
                                                        class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star"
                                                                                                     aria-hidden="true"></i><i
                                                        class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star"
                                                                                                     aria-hidden="true"></i>
                                            </div>
                                            <span class="review"></span></a></li>
                                    <li><a href="{{Request::url()}}?rating=4">
                                            <div class="rating"><i class="fa fa-star" aria-hidden="true"></i><i
                                                        class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star"
                                                                                                     aria-hidden="true"></i><i
                                                        class="fa fa-star" aria-hidden="true"></i></div>
                                            <span class="review"></span></a></li>
                                    <li><a href="{{Request::url()}}?rating=3">
                                            <div class="rating"><i class="fa fa-star" aria-hidden="true"></i><i
                                                        class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star"
                                                                                                     aria-hidden="true"></i>
                                            </div>
                                            <span class="review"></span></a></li>
                                    <li><a href="{{Request::url()}}?rating=2">
                                            <div class="rating"><i class="fa fa-star" aria-hidden="true"></i><i
                                                        class="fa fa-star" aria-hidden="true"></i></div>
                                            <span class="review"></span></a></li>
                                    <li><a href="{{Request::url()}}?rating=1">
                                            <div class="rating"><i class="fa fa-star" aria-hidden="true"></i></div>
                                            <span class="review"></span></a></li>
                                </ul>
                            </div>
                            ...
                            <div class="leftList">
                                ...
                                <ul>
                                    <li><a href="{{Request::url()}}?price=0-100">{{Helper::getPricesymbol()}} 0
                                            - {{Helper::getPricesymbol()}} 100</a></li>
                                    <li><a href="{{Request::url()}}?price=100-1000">{{Helper::getPricesymbol()}} 100
                                            - {{Helper::getPricesymbol()}} 1000</a></li>
                                    <li><a href="{{Request::url()}}?price=1000-5000">{{Helper::getPricesymbol()}} 1000
                                            - {{Helper::getPricesymbol()}} 5000</a></li>
                                    <li><a href="{{Request::url()}}?price=5001-inf">Over {{Helper::getPricesymbol()}}
                                            5000</a></li>
                                </ul>
                            </div>
                    ...
                    <div class="col-sm-9">
                        <div class="innerAds"><img src="{{asset('assets/images/eventday/innerads.jpg')}}"
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 five-three">
                                    <div class="row">
                                        <div class="col-md-5 col-sm-5 col-xs-12">
                                            ...
                                            <label><input type="radio" value='business'
                                                          name="type" {{ !$iseventsearch?"checked":""}} /> Business
                                                Search</label>
                                            <label><input type="radio" value='event'
                                                          name="type" {{ $iseventsearch?"checked":""}} /> Events Search</label>
                                        </div>
                                            ...
                                            <div class="panel panel-default">
                                                <a href="{!! url('ads/details',$ad->slug) !!}">
                                                    <div class="panel-image">
                                                        ...
                                                        @if($ad->photo)
                                                            <img src="{{ URL::to('/thumbnail/'.$ad->photo)  }}"
                                                                 class="img-responsive img-hove"
                                                                 alt="{!! $ad->title !!}">
                                                        @else
                                                            <img class="img-responsive img-hover"
                                                                 src="{{asset('assets/images/eventday/post1.jpg')}}"
                                                                 alt="{!! $ad->title !!}">
                                                        @endif
                                                    </div>
                                                </a>
                                                <div class="panel-body">
                                                    ...
                                                    <ul class="ratingAds">
                                                        <li>
                                                            ...
                                                            <div data="{!! $ad->id !!}" id="stars"
                                                                 class="stars starrr rating"
                                                                 data-rating='{!! (int)$ad->averagerating !!}'
                                                                 data-logged="{{Sentinel::check()?true:false}}"></div>

                                                            <!-- <div class="rating"><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i></div> -->
                                                            <span class="review">(<span
                                                                        id="total-{!! $ad->id!!}">{!! count($ad->ratings) !!}</span>)</span>
                                                        </li>
                                                    </ul>
                                                    <a href="{!! url('ads/details',$ad->slug) !!}">
                                                        <div class="date">{{--$ad->created_at->diffForHumans()--}}</div>
                                                        <div class="address"><i class="fa fa-map-marker"
                                                                                aria-hidden="true"></i> {!! str_limit($ad->description,150, '...') !!}
                                                        </div>
                                                ...
                                                <div class="navPhotoVideo">
                                                    <a href="{!! url('ads/details',$ad->slug) !!}">More Detail</a><a
                                                            href="#">Photo</a><a href="#">Video</a>
                                                </div>
                                                <div class="adsThumnelButton"><a
                                                            href="{{ url('ads/details',$ad->slug)}}?booknow=true"
                                            ...
                                            <div class="panel panel-default">
                                                <a href="{!! url('event',$event->slug) !!}">
                                                    <div class="panel-image">
                                                        ...
                                                        @if($event->photo)
                                                            <img src="{{ URL::to('/thumbnail/'.$event->photo)  }}"
                                                                 class="img-responsive img-hove"
                                                                 alt="{!! $event->title !!}">
                                                        @else
                                                            <img class="img-responsive img-hover"
                                                ...
                                                <div class="panel-body">
                                                    <a href="{!! url('event',$event->slug) !!}">
                                                        <h3>{!! $event->name !!} </h3></a><br/>
                                                    <ul class="ratingAds">
                                                        <li>

                                                            <div data="{!! $event->id !!}" id="stars"
                                                                 class="stars starrr rating"
                                                                 data-rating='{!! (int)$event->averagerating !!}'
                                                                 data-logged="{{Sentinel::check()?true:false}}"></div>

                                                            <!-- <div class="rating"><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i></div> -->
                                                            <span class="review">(<span
                                                                        id="total-{!! $event->id!!}">{!! count($event->ratings) !!}</span>)</span>
                                                        </li>
                                                    </ul>
                                                    <a href="{!! url('event',$event->slug) !!}">
                                                ...
                                                <div class="navPhotoVideo">
                                                    <a href="{!! url('event',$event->slug) !!}">More Detail</a><a
                                                            href="#">Photo</a><a href="#">Video</a>
                                                </div>
                                                <div class="adsThumnelButton"><a
                                                            href="{{ url('event',$event->slug)}}?booknow=true"
                                                            class="btn btn-primary">Book Now</a></div>
                                            </div>
                                        </div>
                                    @endforeach
