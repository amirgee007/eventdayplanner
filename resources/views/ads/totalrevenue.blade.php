                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <div class="table-responsive">
                                    ...
                                    <a href="#" class="link withdraw" data-toggle="modal" data-target="#myModal">Withdraw
                                        amount</a>
                                            ...
                                            <div class="row">
                                                @if($ad->photo)
                                                    <div class="col-sm-3"><img
                                                                src="{{ URL::to('thumbnail/'.$ad->photo)  }}"
                                                                class="img-responsive" alt="Image"></div>
                                                @else
                                                    <div class="col-sm-3"><img width="231"
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    <a href="{{ route('manage-ads',$ad) }}" class="manage">View
                                                        Bookings</a>
