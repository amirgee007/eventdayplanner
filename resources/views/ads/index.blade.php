                            ...
                            @forelse ($ads as $ad)
                                <tr>
                                    ...
                                    <td>
                                        <div class="row">
                                            @if($ad->photo)
                                                <div class="col-sm-6"><img src="{{ URL::to('thumbnail/'.$ad->photo)  }}"
                                                                           class="img-responsive" alt="Image"></div>
                                            @else
                                                <div class="col-sm-6"><img width="231"
                                                                           src="{{ asset('assets/images/eventday/adspic.jpg') }}"
                                    ...
                                    <td><a href="{{ route('manage-ads',$ad) }}"
                                           class="manage">{{ count($ad->booking) }}</a></td>

                                    <td>
                                        <p data-placement="top" data-toggle="tooltip" title="Edit">
                                            <a class="btn btn-primary btn-xs" data-title="Edit"
                                               href="{!! route('edit-ads',$ad)!!}"><span
                                                        class="glyphicon glyphicon-pencil"></span></a>
                                        <!-- <button class="btn btn-primary btn-xs" data-title="Edit" href="{!! route('edit-ads',$ad)!!}"  data-toggle="modal" data-target="#edit" ><span class="glyphicon glyphicon-pencil"></span></button> -->
                                        </p>
                                    </td>
                                    <td>
                                        <p data-placement="top" data-toggle="tooltip" title="Delete">
                                            <button class="btn btn-danger btn-xs" data-title="Delete"
                                                    data-href="{!! route('delete-ads',$ad)!!}" data-toggle="modal"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer ">
                    ...
                    <a data-dismiss="modal" class="btn btn-danger btn-ok"><span class="glyphicon glyphicon-remove"></span>No</a>
                ...
                <div class="the-box no-border event-detail-content">
                    ...
                    <p class="additional-post-wrap">
                            ...
                            <i class="fa fa-level-up"
                               aria-hidden="true"></i> {!! $ads_category[$ad->ads_category_id] !!}
                            </span>
                        <span class="additional-post">
                              <div class="address"><i class="fa fa-map-marker"
                                                      aria-hidden="true"></i> {!! $ad->location !!}</div>
                            </span>
                    ...
                    <p class="pull-right">
                        ...
                        <a href="{!! route('delete-ads',$ad)!!}"><i class="fa fa-close" aria-hidden="true"></i>
                            Delete</a>
                    </p>
                        ...
                        <div class="tab-pane active" id="tab_default_1">
                                ...
                                <div class="media-left tab col-sm-6 col-md-12 col-xs-12">
                                    <a href="#">
                                        <img class="media-object img-responsive"
                                             src="{{ asset('assets/images/img_3.jpg') }}" alt="image">
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="media">
                                <div class="media-left tab col-sm-6 col-md-12 col-xs-12">
                                    <a href="#">
                                        <img class="media-object img-responsive"
                                             src="{{ asset('assets/images/img_5.jpg') }}" alt="image">
                                    </a>
                                </div>
                            </div>
                ...
                <ul class="media-list media-xs media-dotted">
                    <li class="media">
                        <a class="pull-left" href="#">
                            <img src="{{ asset('assets/images/authors/avatar.jpg') }}"
                                 class="img-circle img-responsive pull-left" alt="riot">
                        </a>
                    ...
                    <li class="media">
                        <a class="pull-left" href="#">
                            <img src="{{ asset('assets/images/authors/avatar1.jpg') }}"
                                 class="img-circle img-responsive pull-left" alt="riot">
                        </a>
                        <div class="media-body">
                            <h4 class="media-heading primary">
                    ...
                    <li class="media">
                        <a class="pull-left" href="#">
                            <img src="{{ asset('assets/images/authors/avatar5.jpg') }}"
                                 class="img-circle img-responsive pull-left" alt="riot">
                        </a>
                        <div class="media-body">
                            <h4 class="media-heading primary">
