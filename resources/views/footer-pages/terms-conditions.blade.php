    ...
    <div class="breadcum">
        <div class="container">
            ...
            <div class="pull-right">
                <i class="livicon icon3" data-name="users" data-size="20" data-loop="true" data-c="#3d3d3d" data-hc="#3d3d3d"></i> Terms & Conditions
            </div>
        </div>
    </div>
    @stop
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-7 col-sm-12 wow bounceInLeft" data-wow-duration="5s">
                <h2><label>Welcome to Terms & Conditions</label></h2>
                <p>
