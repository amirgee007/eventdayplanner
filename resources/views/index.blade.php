...
<section class="bannerWrapper">
    ...
    <div class="adsBanner">
      ...
      <div class="row">
        <div class="col-xs-4 col-sm-4"><img src="{{ asset('assets/images/eventday/ads2.jpg')}}" class="img-responsive"></div>
        <div class="col-xs-4 col-sm-4"><img src="{{ asset('assets/images/eventday/ads3.jpg')}}" class="img-responsive"></div>
        <div class="col-xs-4 col-sm-4"><img src="{{ asset('assets/images/eventday/ads4.jpg')}}" class="img-responsive"></div>
      </div>
      </div>
    </div>
