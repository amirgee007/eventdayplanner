                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <img src="data:image/png;base64,{{ DNS1D::getBarcodePNG($booking->id,'C39+',3,133) }}"
                             alt="barcode"/>
                        <br/>
                        <span><a href="{{url('event',$event->slug)}}"
                                 title="{{ $event->name}}"> More Details on "{{ $event->name }}"</a></span>&nbsp;|&nbsp;<span><a
                                    href="{{ url('events/downloadticket',$booking->id)}}">Download PDF</a></span>
                    </div>
                </div>
            </div>
        </div>
